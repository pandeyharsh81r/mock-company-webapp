...
public class SearchController {
    ...
    // Implementing SearchService in SearchController class
    private final SearchService searchService;

    // Updating constructor for implementing SearchService
    @Autowired
    ...
    public Collection<ProductItem> search(@RequestParam("query") String query) {
        // Method implementation was moved to SearchService, delegate query to the service
